...
class TmAccountInvoice(models.Model):
    ...
    discount = fields.Monetary(string='Discount', digits=(16, 3), default=0.0, compute='_compute_amount',
                               track_visibility='always')
    total_before_discount = fields.Monetary(string='Total Before Discount', digits=(16, 3),
                                            compute='compute_total_before_discount')
    timbre = fields.Float(string='Timbre fiscal', readonly=True, digits=(16, 3), compute='_compute_amount',
...
class AccountInvoiceLine(models.Model):
    ...
    subtotal_price = fields.Float(string='Montant', digits=(16, 2), store=True, compute='compute_line_price')
